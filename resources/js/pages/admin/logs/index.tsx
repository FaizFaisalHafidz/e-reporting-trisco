...
import { Activity, Clock, Database, Download, Eye, Filter, Search, Shield, Users } from 'lucide-react';
...
export default function LogsIndex({ logs, users, moduls, aktivitas, stats, filters }: Props) {
    ...
    const applyFilters = () => {
        ...
        router.get(route('admin.logs.index'), filtersForBackend, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    const exportLogs = () => {
        ...
        window.open(route('admin.logs.export', filtersForExport));
    };
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold text-blue-600">{stats.total_logs.toLocaleString()}</div>
                            </CardContent>
                        </Card>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold text-green-600">{stats.today_logs.toLocaleString()}</div>
                            </CardContent>
                        </Card>

                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium">Log Login</CardTitle>
                                <Shield className="h-4 w-4 text-muted-foreground" />
                            </CardHeader>
                            <CardContent>
                                <div className="text-2xl font-bold text-purple-600">{stats.login_logs.toLocaleString()}</div>
                            </CardContent>
                        </Card>

                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium">Log Sistem</CardTitle>
                                <Database className="h-4 w-4 text-muted-foreground" />
                            </CardHeader>
                            <CardContent>
                                <div className="text-2xl font-bold text-orange-600">{stats.system_logs.toLocaleString()}</div>
                            </CardContent>
                        </Card>
                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Menampilkan {logs.total.toLocaleString()} log aktivitas
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Table>
                                ...
                                <TableBody>
                                    {logs.data.map((log) => (
                                        <TableRow key={log.id}>
                                            ...
                                            <TableCell>
                                                <Badge className={getActivityColor(log.aktivitas)}>
                                                    {log.aktivitas}
                                                </Badge>
                                            </TableCell>
                                            <TableCell>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="capitalize">{log.modul}</span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
